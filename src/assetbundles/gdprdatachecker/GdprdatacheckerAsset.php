...
namespace adigital\gdprdatachecker\assetbundles\Gdprdatachecker;
...
/**
 * GdprdatacheckerAsset AssetBundle
 *
 ...
 * @since     1.0.0
 */
class GdprdatacheckerAsset extends AssetBundle
{
    // Public Methods
    // =========================================================================
    ...
    public function init()
    {
        ...
        $this->js = [
            'js/Gdprdatachecker.js',
        ];

        $this->css = [
            'css/Gdprdatachecker.css',
        ];
